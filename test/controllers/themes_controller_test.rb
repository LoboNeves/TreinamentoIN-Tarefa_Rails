...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { department: @theme.department, name: @theme.name } }, as: :json
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { department: @theme.department, name: @theme.name } }, as: :json
    assert_response 200
  end
